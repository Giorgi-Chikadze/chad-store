...
class ProductViewSet(RetrieveModelMixin, CreateModelMixin, ListModelMixin, UpdateModelMixin, DestroyModelMixin, GenericAPIView):
...
class TagViewSet(ListModelMixin, GenericAPIView):
